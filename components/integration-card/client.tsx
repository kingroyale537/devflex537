...
export default function IntegrationCard({ type, index }: IntegrationCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`${details.color} shadow-lg rounded-2xl p-6 transition-shadow hover:shadow-lg border border-black`}
    >
      <div className="flex items-start justify-between mb-4">
        <div className="p-3 bg-white rounded-xl shadow-sm border border-black">{details.icon}</div>
        <span
      ...
      <h3 className="text-xl font-semibold mb-2 text-black">{details.title}</h3>
