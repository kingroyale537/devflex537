  ...
  return (
    <TooltipProvider>
      <div className="text-2xl font-bold mb-4 text-black animate-fade-in">
        <h2>
          Latest Articles <ArrowDown strokeWidth={2} className="inline text-black" />
        </h2>
      </div>
...
const BlogCard = ({ blog, index }: { blog: MediumBlog; index: number }) => {
  ...
  return (
    <div className="bg-white rounded-xl border-1 border-black border-b-4 flex flex-col h-full transform transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-lg will-change-transform overflow-hidden shadow-[2px_2px_0px_rgba(0,0,0,1)]">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex justify-between items-center">
          ...
          <Tooltip>
            ...
            <TooltipContent>Visit Article</TooltipContent>
          </Tooltip>
        </div>
      </div>
    </div>
