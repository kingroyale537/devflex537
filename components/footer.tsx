...
import {
  ...
  PORTFOLIO_DISCORD_LINK,
  PORTFOLIO_GITHUB_LINK,
  PORTFOLIO_INSTAGRAM_LINK,
        ...
        <div className="flex flex-col md:flex-row justify-around gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href={PORTFOLIO_BUY_ME_A_COFFEE_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#F3F3F3] opacity-60 hover:opacity-100 text-sm"
                >
