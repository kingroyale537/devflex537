...
const ProjectCard = ({
  ...
  const previewUrl = isGithubPreview
    ? `https://opengraph.githubassets.com/317f0ed00d6d6d4a22f24b956b3988bc254e791fcfe1955acef5add1764cfb42/${encodeURIComponent(owner)}/${encodeURIComponent(repoName)}`
  ...
  const separatorColor = SEPARATOR_COLORS[getColorIndex(name)] || SEPARATOR_COLORS[0];

  return (
    <TooltipProvider>
      <div className="bg-white rounded-xl border-1 border-black border-b-4 w-full h-full flex flex-col transform transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-lg will-change-transform overflow-hidden">
        ...
        <div className="p-6 pt-1 flex flex-col flex-1">
          <div className="flex-1">
            <h3
              className="font-bold text-lg mb-2 text-black animate-slide-up will-change-transform"
            ...
            <div className="flex gap-2">
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    <Github className="w-4 h-4 stroke-[1.5] text-black transition-transform duration-300 ease-out group-hover:scale-110" />
                  </Link>
                </TooltipTrigger>
              ...
              {homepage && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <ExternalLink className="w-4 h-4 stroke-[1.5] text-black transition-transform duration-300 ease-out group-hover:scale-110" />
                    </Link>
                  </TooltipTrigger>
