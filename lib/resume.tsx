  ...
  <Document>
    <Page style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        {data.achievements.issues_closed !== 0 && (
          <Text style={styles.text}>
        ...
        {data.achievements.pull_requests_merged !== 0 && (
          <Text style={styles.text}>
      ...
      <View style={styles.section}>
        <Text style={styles.disclaimerText}>
          *Autogenerated via{" "}
          <Link style={[styles.link, { fontSize: 7 }]} src="https://portfoliomaker.io">
            portfoliomaker.io
          </Link>
        </Text>
      </View>
...
async function getResumeData(username: string): Promise<ResumeData> {
  ...
  if (linkedInUsername) {
    userLinkedInProfile = await getLinkedInProfileData(linkedInUsername);
  }
...
export async function generateResumePDF(username: string): Promise<Buffer> {
  ...
  return (await renderToBuffer(<ResumeDocument data={resumeData} />)) as Buffer;
}
